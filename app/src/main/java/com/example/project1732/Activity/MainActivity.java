            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (list.size() > 0) {
                        ...
                        RecyclerView.Adapter<CategoryAdapter.viewholder> adapterCategory = new CategoryAdapter(list);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (list.size() > 0) {
                        ...
                        RecyclerView.Adapter<BestFoodAdapter.viewholder> adapterBestFood = new BestFoodAdapter(list);
